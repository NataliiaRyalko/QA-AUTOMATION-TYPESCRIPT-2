...
const someNewString = 'hello!';
const someBool = true;
const someNewBool = false;
const someNull = null;
const someNewNull = null;
const someUndefined = undefined;
const someNewUndefined = undefined;
const someObject = {name: 'Ivan', age: 25};
const someNewObject = {name: 'Ann', age: 55};
const someSymbol = Symbol('!');
const someNewSymbol = Symbol('#');
